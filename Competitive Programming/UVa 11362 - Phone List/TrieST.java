...
public class TrieST<Value> {
    private static final int R = 256;        // My English Alphabet set.
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            key[i] = StdIn.readString();
            // System.out.println("longest : " + st.longestPrefixOf("9"));
            // st.put(key, i);
        }
        Arrays.sort(key);
        
        for (int i = 0; i < 5; i++) {
            System.out.println("Hello : " + st.hasPrefix(key[i]));
            st.put(key[i], i);
        }
        ...
        // for (String key : st.keysWithPrefix("983")) {
